...
function onMapClick(e) {
  popup
      .setLatLng(e.latlng)
      .setContent("You clicked the map at " + e.latlng.toString()) //example from leaflet, will be immediately replaced by weatherpopup...
      .openOn(map);
...
$.ajax({
  url: "https://api.openweathermap.org/data/2.5/weather?lat=" + e.latlng.lat + '&lon=' + e.latlng.lng + "&appid=351ea9159e335c8a8180799a59aa9403",
  dataType: 'json',
...
map.on('click', onMapClick);
    ...
    //Lat and Long shows in weather menu.
    // function onMapClickLatlng(e) {
    // document.getElementById('lat').innerText = "Lat: "+ e.latlng.lat.toFixed(2);
    // document.getElementById('lng').innerText = 'Long: '+ e.latlng.lng.toFixed(2);
    // };
    // map.on('click', onMapClickLatlng)